...
export default function ProductCard(props: {handle: string, title: string, image: string, price: number, currencyCode: string}) {
    ...
    return (
        <div className="box-border rounded-md overflow-hidden shadow-sm hover:shadow-lg">
                <div className="bg-white h-full flex flex-col">
                    ...
                    <div className="p-4 flex flex-col justify-between h-full items-center">
                        ...
                        <span className="bg-primary-100 p-1 rounded-full text-white text-sm mt-3 hover:bg-white hover:text-primary-200 border"><Link href={`/products/${props.handle}`}>More</Link></span>
