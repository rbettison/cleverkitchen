...
export default async function Home() {
  ...
  return (
    ...
    <div className="mt-40 sm:mt-0 w-full gap-8 mb-48 sm:h-screen sm:grid flex flex-col items-center sm:text-left text-center grid-cols-4 grid-rows-5 justify-between">
