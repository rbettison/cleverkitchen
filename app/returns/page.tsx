export default function Returns() {
    return (
        <div className={"my-24 mx-10"}>
            ...
            <p>To start a return, you can contact us at cleverkitcheninfo@gmail.com. Please note that returns will need to be sent to the following address:
                Bettison Bros. Ltd, London, ENG, WC2H9JQ, United Kingdom</p>

            <p>If your return is accepted, we’ll send you a return shipping label, as well as instructions on how and where to send your package. Items sent back to us without first requesting a return will not be accepted. Please note that if your country of residence is not United Kingdom, shipping your goods may take longer than expected.</p>

            <p>You can always contact us for any return questions at cleverkitcheninfo@gmail.com.</p>
            ...
            <p>If more than 15 business days have passed since we’ve approved your return, please contact us at cleverkitcheninfo@gmail.com.</p>
